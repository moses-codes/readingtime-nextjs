...
export default function Alert({ type, title = 'Book' }) {
    ...
    if (type === 'deleted') {
        return (
            ...
            >
                <div className='ease-in-out z-50 animate-alert-pop'>
                    <div className=" alert alert-warning fixed bottom-4 left-1/2 transform -translate-x-1/2 min-w-min max-w-max  text-black py-2 px-4 rounded-lg z-50 flex justify-start items-center">
        ...
        return (
            <div
                ...
                <div className=" alert alert-info fixed bottom-4 left-1/2 transform -translate-x-1/2 min-w-min max-w-max bg-blue-500 text-white py-2 px-4 rounded-lg z-50 flex justify-start items-center">
